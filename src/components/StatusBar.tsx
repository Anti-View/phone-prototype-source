export default function StatusBar() {
  return (
    ...
    >
      {/* Time — flex:1, centered */}
      <div
        className="flex items-center justify-center"
        style={{ flex: '1 1 0', height: 22, paddingTop: 1.5, gap: 10 }}
      >
        <span
          style={{
            textAlign: 'center',
      ...
      {/* Icons — flex:1, centered, gap 7px */}
      <div
        className="flex items-center justify-center"
        style={{ flex: '1 1 0', height: 22, paddingTop: 1, paddingRight: 1, gap: 7 }}
      >
        {/* Signal */}
        ...
        <svg width="28" height="13" viewBox="0 0 28 13" fill="none">
          ...
          <path opacity="0.4" d="M26 4.5V8.57547C26.8047 8.2303 27.328 7.42734 27.328 6.53774C27.328 5.64813 26.8047 4.84517 26 4.5Z" fill="black" />
